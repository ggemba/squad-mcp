...
function sanitizeShape(shape: Record<string, unknown> | undefined): Record<string, unknown> | undefined {
...
export const logger = {
  error: (msg: string, fields: Omit<LogEntry, 'level' | 'msg'> = {}) => log({ level: 'error', msg, ...fields }),
  warn: (msg: string, fields: Omit<LogEntry, 'level' | 'msg'> = {}) => log({ level: 'warn', msg, ...fields }),
  info: (msg: string, fields: Omit<LogEntry, 'level' | 'msg'> = {}) => log({ level: 'info', msg, ...fields }),
  debug: (msg: string, fields: Omit<LogEntry, 'level' | 'msg'> = {}) => log({ level: 'debug', msg, ...fields }),
};
